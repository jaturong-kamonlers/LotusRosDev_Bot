...
Kinematics::Kinematics(base robot_base, int motor_max_rpm, float max_rpm_ratio_l,float max_rpm_ratio_r,
...
{    
    ...
    max_rpm_ =  ((motor_power_max_voltage / motor_operating_voltage) * motor_max_rpm) * max_rpm_ratio_l;
    max_rpm_r_ =  ((motor_power_max_voltage / motor_operating_voltage) * motor_max_rpm) * max_rpm_ratio_r;
}
...
Kinematics::rpm Kinematics::calculateRPM(float linear_x, float linear_y, float angular_z)
{
    ...
    rpm.motor2 = constrain(rpm.motor2, -max_rpm_r_, max_rpm_r_);
    ...
    rpm.motor4 = constrain(rpm.motor4, -max_rpm_r_, max_rpm_r_);
